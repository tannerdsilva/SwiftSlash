...
extension Tag {
	@Tag internal static var __cswiftslash_auint8:Self
}
...
extension __cswiftslash_tests {
	...
	internal struct __cswiftslash_auint8 {
		...
		@Test("__cswiftslash_auint8 :: load and store values 0...255", .timeLimit(.minutes(1)))
		...
		@Test("__cswiftslash_auint8 :: compare exchange weak tests :: success return :: (0...255)", .timeLimit(.minutes(1)))
		...
		@Test("__cswiftslash_auint8 :: compare exchange weak tests :: failure return :: (0...255)", .timeLimit(.minutes(1)))
		...
		@Test("__cswiftslash_auint8 :: fuzz testing atomic operations", .timeLimit(.minutes(1)))
		...
		@Test("__cswiftslash_auint8 :: concurrent atomic operations tests", .timeLimit(.minutes(1)))
		...
		@Test("__cswiftslash_auint8 :: edge case testing", .timeLimit(.minutes(1)))
