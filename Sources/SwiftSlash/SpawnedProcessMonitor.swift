...
//	
//	private let runLoopAccess = DispatchQueue(label:"com.swiftslash.process-monitor.run-loop.sync", target:swiftslashCaptainQueue)
...
//		return try internalSync.sync { () -> PosixPipe
